...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#f8c3fa] p-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div className="flex items-center">
          <span className=" text-lg font-bold">Mobile Shop</span>
        </div>
        <div className="hidden md:flex">
          ...
          <a href="#" className="text-[#19130b] font-bold px-3 py-2 hover:bg-[#d3e03d]">CONTACT</a>
        </div>
